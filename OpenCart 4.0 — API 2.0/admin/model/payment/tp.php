<?php
namespace Opencart\Admin\Model\Extension\OcPaymentTP\Payment;
    ...
    public function install(): void
    {
        ...
        if (VERSION >= '4.0.2.0') {
            $this->model_setting_event->addEvent([
                ...
                'action' => 'extension/oc_payment_tp/payment/tp.order_info',
                'status' => true,
                'sort_order' => 1
            ]);
            $this->model_setting_event->addEvent([
                'code' => 'payment_tp_order_list',
                'description' => '',
                'trigger' => 'admin/view/sale/order_list/before',
                'action' => 'extension/oc_payment_tp/payment/tp.order_list',
                'status' => true,
                'sort_order' => 2
            ]);
            ...
            $this->model_setting_event->addEvent(
                'payment_tp_order_list',
                '',
                'admin/view/sale/order_list/before',
                'extension/oc_payment_tp/payment/tp|order_list',
                true,
                2
            );
        }
