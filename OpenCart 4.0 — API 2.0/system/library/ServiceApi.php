<?php
namespace Opencart\System\Library\Extension\OcPaymentTP;
/**
 * Class ServiceApi
 */
...
final class ServiceApi
{
    ...
    public function __construct($registry=null)
    {
        ...
        $this->posId = trim( $this->config->get('payment_tp_pos_id'));
        $this->apiKey = trim( $this->config->get('payment_tp_api_key'));
        $this->apiSecret = trim( $this->config->get('payment_tp_api_secret'));
        $this->endpointsKey = trim( $this->config->get('payment_tp_endpoints_key'));
        $this->type_payment = ( $this->config->get('payment_tp_type_payment') == '1') ? 1 : 0;
