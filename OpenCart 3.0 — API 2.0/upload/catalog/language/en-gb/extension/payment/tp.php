...
$_['text_pay_success']	= 'was successfully paid in %1$s. For the sum of %2$s';
...
$_['text_pay_refund_custom'] = 'Funds for order No. %1$s in the amount of %2$s have been successfully refunded through %3$s';
$_['text_pay_void_custom'] = 'The reservation created for order #%1$s in the amount of %2$s have been successfully released (voided) via %3$s.';
$_['text_pay_success_custom'] = 'The reservation for order No. %1$s has been successfully processed within %2$s for the amount of %3$s.';
